...
and year are! */
SELECT customer_id, strftime('%m', transaction_time) AS month, strftime('%Y', transaction_time) AS year FROM customer_purchases;
...
FROM customer_purchases WHERE strftime('%Y-%m', transaction_time) = '2019-04'
